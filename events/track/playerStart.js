...
const GControl = require("../../settings/database/control.js")
const GLang = require("../../settings/database/language.js")
const Setup = require("../../settings/database/setup.js")

module.exports = async (client, player, track) => {
  const guild = await client.guilds.cache.get(player.guildId)
  console.log(`Player Started in @ ${guild.name} / ${player.guildId}`);
